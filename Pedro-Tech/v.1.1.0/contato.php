...
<body>
    ...
    <div class=social>
        ...
        <div class="contain">
            <div class="icons-container animated" style="background-color: rgba(0 0 0 / 60%);flex-wrap: wrap;">
                <div class="icon-container">
                ...
                <div class="icon-container">
                    <a style="color:white;" href="https://www.youtube.com/channel/UCK2PhXti63Mcb9Z7kOSOaIg" target="_blank" class=button><i class="fa-brands fa-youtube fa-2x" style="margin: 0 -3px;"></i></a>
                </div>
                <div class="icon-container">
